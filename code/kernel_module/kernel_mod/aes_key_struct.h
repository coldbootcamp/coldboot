...
void AES_128_Key_Expansion (char *userKey, key_schedule_t *key);

void AES_192_Key_Expansion (char *userKey, key_schedule_t *key);

void AES_256_Key_Expansion (char *userKey, key_schedule_t *key);
